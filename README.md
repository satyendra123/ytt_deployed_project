...
2nd method- in the django make a run_server.spec folder and inside it write this. this will generate the exe and after writting this just python -m PyInstaller run_server.spec write this command. and it will build the exe for you
